...
class FolhaDeSaoPauloSpider(scrapy.Spider):
    ...
    def load_article_item(self, response):
        ...
        l.add_fallback_css('text', '.content')
        # TODO: Add publisher
