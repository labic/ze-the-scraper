...
class ValorEconomicoSpider(scrapy.Spider):
    ...
    def __init__(self, url=None, query=None, editorial=None, subject=None, when=None, contentType=None, *args, **kwargs):
        super(ValorEconomicoSpider, self).__init__(*args, **kwargs)
    ...
    def parse_article(self, response):
        ...
        l.add_fallback_css('name', '.title1::text')
        l.add_css('authors', '[itemprop=author]::text')
        l.add_fallback_css('authors', '.node-author-inner strong::text')
        l.add_fallback_css('authors', '.first::text')
        ...
        l.add_fallback_css('date_published', 'span.date::text')
        l.add_css('date_modified', '[itemprop=dateModified]::attr(content)')
        l.add_fallback_css('date_modified', '.node-body p em::text')
